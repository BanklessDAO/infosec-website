...
function Services() {
  return (
    <>
      <SectionIntro
        eyebrow="Services"
        title="Our end-to-end services include"
        className="mt-24 sm:mt-32 lg:mt-40"
      >
        <p className='text-white'>
          We provide full-stack blockchain infrastructure services, from
          architecture to ongoing operations and tooling.
        </p>
      </SectionIntro>
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
            ...
            <ListItem title="CI/CD pipeline development">
              ...
              automated testing, auditing, and release management of your web3
              dApp.
            </ListItem>
            <ListItem title="Monitoring, logging, and alerting">
              We implement robust monitoring, log aggregation, and alerting to
              provide visibility and rapid incident response for blockchain
              networks and nodes.
            </ListItem>
            <ListItem title="Performance testing and optimization">
              We conduct load tests, benchmarking, and performance optimizations
              to ensure speed, throughput, and low latency of transactions.
            </ListItem>
          </List>
        </div>
      </Container>
...
export const metadata: Metadata = {
  description:
    'Our team of DevOps and SRE engineers is dedicated to building excellent web platform infrastructure.',
}
  ...
  return (
    <>
      ...
      >
        ...
        decentralized innovation to travel upon securely and at scale.
      </Testimonial>
